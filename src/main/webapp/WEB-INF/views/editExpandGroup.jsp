...
<body>
 ...
 <c:if test="${expandGroup.outgroupID eq id }">
    <div class="login-wrap">
    <div class="login-html">
      <input id="tab-1" type="radio" name="tab" class="sign-in" checked /><label for="tab-1" class="tab">支出组的创建</label>
      <div class="login-form">
        <div class="sign-in-htm">
         <form action="/FinacialSys/editExpandGroup/${current}/${id}" id="createExpandGroup" method="post">
	          <div class="group">
	            <label for="outgroup_Brief" class="label">支出组简介</label>
	            <textarea name="outgroupBrief"  required="required" form="createExpandGroup" class="input label3" cols=40 rows=4>${expandGroup.outgroupBrief }</textarea>
	          </div>
	          <div class="group">
	            <label for="outgroup_Msg" class="label">支出组详细信息</label>
	            <textarea name="outgroupMsg"form="createExpandGroup" class="input label2" cols=40 rows=4>${ expandGroup.outgroupMsg }</textarea>
	          </div>
	          <div class="group">
