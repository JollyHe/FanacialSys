 ...
 <nav id="menu" class="navbar">
    ...
    <div class="row" >
            ...
            <div class="col-md-2 col-md-offset-1" id="form-left">
               <select name="log.logID" form="expand" placeholder="便签" size="1" id="log"> 
            ...
            <div class="col-md-6" id="form-center">
          	        <form id="expand" action="createExpand" method="post">
          		        <input required='' type='text' name="outMoney">
          		        <label alt='支出金额' placeholder='支出金额'></label>
          		        <input required='' type='text' name="outPlace">
          		        <label alt='支出地点' placeholder='支出地点'></label>          	    
          		        <input required='' type='text' name="outMessage">
          		        <label alt='支出详细信息' placeholder='信息' ></label>         	    
                      <input required='' type='date' name="outTime">
                    </form>
          	        <button id="submit" form="expand" class="btn1">创 建</button>
            </div>
              <div id="form-right" class="col-md-2">

               <select name="expandgroup.outgroupID" form="expand" placeholder="便签" size="1" id="log">      
