...
<body>
 <nav id="menu" class="navbar">
    ...
    <div class="login-html">
      <input id="tab-1" type="radio" name="tab" class="sign-in" checked /><label for="tab-1" class="tab">收入组的创建</label>
      <div class="login-form">
        <div class="sign-in-htm">
         <form action="createIncomeGroup" id="createIncomeGroup" method="post">
	          <div class="group">
	            <label for="incomegroupBrief" class="label">收入组简介</label>
	            <textarea name="incomegroupBrief" required="required" form="createIncomeGroup" class="input label3" cols=40 rows=4></textarea>
	          </div>
	          <div class="group">
	            <label for="incomegroupMsg" class="label">收入组详细信息</label>
	            <textarea name="incomegroupMsg" form="createIncomeGroup" class="input label2" cols=40 rows=4></textarea>
	          </div>
	          <div class="group">
	            <button type="submit" form="createIncomeGroup" class="btn button" value="创建">创建</button>
	          </div>
          </form>
          <div class="hr"></div>
          <div class="foot-lnk">
