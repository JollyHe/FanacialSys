        ...
        <div class="cont_form_login"> <a href="#" onClick="ocultar_login_sign_up()" ><i class="fa fa-arrow-right"></i></a>
          <h2>附加信息</h2>
          		...
          		<div class="selectGroup">
		         	 ...
		         	 <select name="incomegroup.incomegroupID" form="income" placeholder="便签" size="1">      
							  ...
							  <c:choose >
								  <c:when test="${group.incomegroupID.equals('其他') }">
         ...
         <form id="income" action="createIncome" method="post">
	        <div class="cont_form_sign_up"> <a href="#" onClick="ocultar_login_sign_up()"><i class="fa fa-arrow-left"></i></a>
	          <h2>基本信息</h2> 
		          <input type="text" placeholder="收入金额" name="inMoney"/>
		          <input type="text" placeholder="收入地点" name="inPlace"/>
		          <input type="text" placeholder="收入详细信息" name="inMessage"/>
		          <input type="text" placeholder="收入日期" name="inTime" class="laydate-icon" id="incomeDate"/>
		          <button class="btn_sign_up" form="income">提交</button>      
	        </div>
         <form>
      </div>
    </div>
